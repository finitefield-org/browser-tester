...
- Phase 1 DOM parsing, selector subset support, and Phase 6 selector expansion slices 1 through 4, including class/compound/descendant/child selectors and selector hardening, are implemented
