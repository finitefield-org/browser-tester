...
- backlog-driven work now focuses on collection API broadening slices 1 (`NodeList.forEach` / `HTMLCollection.forEach`), 2 (`document.scripts`), and 3 (`document.anchors`) plus the remaining iterator-style helpers and specialized live collections, selector grammar broadening, and HTML serialization broadening
