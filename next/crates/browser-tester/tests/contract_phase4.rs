...
#[test]
fn location_assign_replace_and_reload_are_available_from_scripts() -> browser_tester_next::Result<()>
{
    let mut harness = Harness::from_html(
...
#[test]
fn location_assign_requires_a_url_from_scripts() -> browser_tester_next::Result<()> {
...
#[test]
fn location_href_is_available_from_scripts() -> browser_tester_next::Result<()> {
    let mut harness = Harness::from_html(
...
#[test]
fn location_stringification_helpers_are_available_from_scripts() -> browser_tester_next::Result<()>
{
...
#[test]
fn location_href_requires_a_url_from_scripts() -> browser_tester_next::Result<()> {
...
#[test]
fn location_hash_is_available_from_scripts() -> browser_tester_next::Result<()> {
    let mut harness = Harness::from_html(
...
#[test]
fn location_pathname_is_available_from_scripts() -> browser_tester_next::Result<()> {
    let mut harness = Harness::builder()
...
#[test]
fn location_search_is_available_from_scripts() -> browser_tester_next::Result<()> {
    let mut harness = Harness::builder()
        .url("https://app.local/start?x#old")
...
#[test]
fn location_origin_is_available_from_scripts() -> browser_tester_next::Result<()> {
    let mut harness = Harness::builder()
        .url("https://app.local:8443/start?x#old")
...
#[test]
fn location_username_and_password_are_available_from_scripts() -> browser_tester_next::Result<()> {
    let mut harness = Harness::builder()
...
#[test]
fn location_port_assignment_rejects_non_numeric_values() -> browser_tester_next::Result<()> {
...
#[test]
fn owner_document_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn parent_node_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn parent_node_assignment_is_rejected() -> browser_tester_next::Result<()> {
    let error = Harness::from_html(
...
#[test]
fn is_connected_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn is_connected_assignment_is_rejected() -> browser_tester_next::Result<()> {
    let error = Harness::from_html(
...
#[test]
fn first_and_last_element_child_are_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn template_content_query_selector_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn template_content_get_element_by_id_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn first_element_child_assignment_is_rejected() -> browser_tester_next::Result<()> {
    let error = Harness::from_html(
...
#[test]
fn owner_document_assignment_is_rejected() -> browser_tester_next::Result<()> {
    let error = Harness::from_html(
...
#[test]
fn document_design_mode_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn document_design_mode_rejects_invalid_values() -> browser_tester_next::Result<()> {
...
#[test]
fn element_content_editable_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn element_content_editable_rejects_invalid_values() -> browser_tester_next::Result<()> {
    let error = Harness::from_html(
...
fn navigator_metadata_is_publicly_supported() -> browser_tester_next::Result<()> {
    ...
    harness.assert_text(
        "#out",
        "browser-tester-next:browser-tester-next:browser-tester-next:browser-tester-next:browser-tester-next:false:unspecified:false:unknown:en-US:en-US:en-US:en-US:unknown:1:en-US:[object DOMStringList]:true:false:true:true:false",
    )?;
    Ok(())
}

#[test]
fn navigator_languages_iterator_helpers_are_publicly_supported() -> browser_tester_next::Result<()>
{
    let harness = Harness::from_html(
...
#[test]
fn navigator_mime_types_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn navigator_mime_types_iterator_helpers_are_publicly_supported() -> browser_tester_next::Result<()>
{
    let harness = Harness::from_html(
...
#[test]
fn collection_to_string_helpers_are_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn document_create_element_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn document_create_text_node_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn document_create_comment_is_publicly_supported() -> browser_tester_next::Result<()> {
    let harness = Harness::from_html(
