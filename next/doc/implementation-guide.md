...
| Selector grammar broadening | 1. `:scope` (delivered) 2. `:has(...)` (delivered) 3. structural selector expansion with richer nested selector handling (delivered) | `bt-dom` | public contract, DOM matcher regression, explicit unsupported syntax |
