...
- `Element.children`, `getElementsByTagName`, `getElementsByClassName`, `getElementsByName`, `document.forms`, `form.elements`, `select.options`, `document.images`, and `document.links` collection support in post-Phase-7 collection slices
