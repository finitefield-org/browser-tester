...
Phase 6 selector expansion is complete; slices 1 through 4 for class selectors, compound simple selectors, descendant combinators, child combinators, and selector hardening are delivered, and any future selector work should follow the post-Phase-6 backlog-driven slice mode.
Phase 7 script DOM query expansion is the next named milestone; it is designed but not yet implemented.
