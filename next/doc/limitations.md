...
- broader collection APIs beyond `NodeList.forEach` / `HTMLCollection.forEach` / `document.scripts` / `document.anchors` and the current bounded DOM collection set; backlog slice: collection API broadening
