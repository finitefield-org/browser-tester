...
- broader collection APIs beyond the current bounded DOM collection set, including further specialized live collections beyond `document.children`, `table.rows` / `tr.cells`, and `select.selectedOptions`; backlog slice: collection API broadening
