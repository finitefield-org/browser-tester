...
- selector matching for `#id`, tag, `[attr]`, `[attr=value]`, `[attr^=value]`, `[attr$=value]`, `[attr*=value]`, `[attr~=value]`, `[attr|=value]`, optional `i` / `s` flags, `.class`, `tag.class`, `#id.class`, selector lists, bounded pseudo-classes including `:lang(...)`, `:dir(...)`, `:link`, `:any-link`, `:placeholder-shown`, `:required`, `:optional`, `:focus`, `:focus-within`, `:target`, descendant combinators, child combinators, adjacent sibling combinators, and general sibling combinators
...
- script-side `document.documentElement`, `document.head`, `document.body`, `document.title`, `window.title`, `document.location`, `window.location`, `document.URL`, `document.documentURI`, `document.baseURI`, `element.baseURI`, `document.origin`, `window.origin`, and `element.origin` are available
