...
- selector matching for `#id`, tag, `[attr]`, `[attr=value]`, `[attr^=value]`, `[attr$=value]`, `[attr*=value]`, `[attr~=value]`, `[attr|=value]`, optional `i` / `s` flags, `.class`, `tag.class`, `#id.class`, selector lists, bounded pseudo-classes including `:lang(...)`, `:dir(...)`, `:link`, `:any-link`, `:placeholder-shown`, `:required`, `:optional`, `:focus`, `:focus-within`, `:target`, `:defined`, descendant combinators, child combinators, adjacent sibling combinators, and general sibling combinators
...
- broader browser-compatible HTML serialization beyond the bounded `innerHTML`, `outerHTML`, `insertAdjacentHTML`, and `template.content.innerHTML` surfaces
- broader CSS parsing beyond the bounded selector grammar, including malformed or unknown attribute selector flags such as `[attr=value x]`; the remaining work is backlog-driven and only added for a specific user-visible gap
