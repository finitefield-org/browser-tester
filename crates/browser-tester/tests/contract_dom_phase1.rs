...
#[test]
fn from_html_builds_dom_and_supports_phase_one_selectors() -> browser_tester::Result<()> {
...
#[test]
fn selector_lists_work_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn selector_hex_escapes_work_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn simple_pseudo_classes_work_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn default_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn indeterminate_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn not_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn is_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
        "<main id='root' class='app' data-kind='APP READY' lang='EN-US'><button id='first' class='primary'>First</button><button id='disabled' class='primary' disabled>Disabled</button><button id='enabled' class='secondary'>Enabled</button></main>",
    )?;
...
#[test]
fn where_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
        "<main id='root' class='app' data-kind='APP READY' lang='EN-US'><button id='first' class='primary'>First</button><button id='disabled' class='primary' disabled>Disabled</button><button id='enabled' class='secondary'>Enabled</button></main>",
    )?;
...
#[test]
fn lang_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn dir_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn range_input_without_explicit_value_defaults_to_in_range() -> browser_tester::Result<()> {
...
#[test]
fn any_link_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn defined_pseudo_class_works_with_public_assert_exists() -> browser_tester::Result<()> {
    let harness = Harness::from_html(
...
#[test]
fn focus_pseudo_classes_work_with_public_assert_exists() -> browser_tester::Result<()> {
...
#[test]
fn assert_exists_reports_missing_nodes_with_dom_dump() -> browser_tester::Result<()> {
...
#[test]
fn unsupported_selector_syntax_is_reported_explicitly() -> browser_tester::Result<()> {
...
#[test]
fn unsupported_not_argument_syntax_is_reported_explicitly() -> browser_tester::Result<()> {
