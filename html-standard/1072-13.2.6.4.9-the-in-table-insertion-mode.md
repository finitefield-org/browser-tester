...
[Source](https://html.spec.whatwg.org/#parsing-main-intable)
...
attribute's value is not an ASCII case-insensitive match for "hidden", then: act as described in the "anything else" entry below.
Otherwise:
• Parse error.
