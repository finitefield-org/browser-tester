...
[Source](https://html.spec.whatwg.org/#named-character-reference-state)
...
Otherwise:
• If the last character matched is not a U+003B SEMICOLON character (;), then this is a
...
OtherwiseFlush code points consumed as a character reference. Switch to the
