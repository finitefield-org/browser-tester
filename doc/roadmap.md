...
This roadmap mirrors the staged plan from [`next.md`](../next.md) and turns it into the working order for this workspace.
...
- independent Rust workspace under `crates/`
- `HarnessBuilder`
- `Session`
- `DomStore`
