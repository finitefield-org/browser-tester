...
impl Harness {
    ...
    pub(crate) fn object_key_from_dom_prop(prop: &DomProp) -> Option<&'static str> {
        match prop {
            ...
            DomProp::Action => Some("action"),
            DomProp::FormAction => Some("formAction"),
            DomProp::Lang => Some("lang"),
            DomProp::Dir => Some("dir"),
            DomProp::AccessKey => Some("accessKey"),
            DomProp::AutoComplete => Some("autocomplete"),
            DomProp::AutoCapitalize => Some("autocapitalize"),
            DomProp::AutoCorrect => Some("autocorrect"),
            DomProp::ContentEditable => Some("contentEditable"),
            DomProp::Draggable => Some("draggable"),
            DomProp::EnterKeyHint => Some("enterKeyHint"),
            DomProp::Inert => Some("inert"),
            DomProp::InputMode => Some("inputMode"),
            DomProp::Nonce => Some("nonce"),
            DomProp::Popover => Some("popover"),
            DomProp::Spellcheck => Some("spellcheck"),
            DomProp::TabIndex => Some("tabIndex"),
            DomProp::Translate => Some("translate"),
            ...
            DomProp::TableCellColSpan => Some("colSpan"),
            DomProp::RowSpan => Some("rowSpan"),
            ...
            DomProp::VideoDisablePictureInPicture => Some("disablePictureInPicture"),
            DomProp::VideoPlaysInline => Some("playsInline"),
            DomProp::VideoPoster => Some("poster"),
            DomProp::AnchorAlt => Some("alt"),
            ...
            DomProp::AnchorNoHref => Some("noHref"),
            ...
            DomProp::Data => Some("data"),
            DomProp::SrcDoc => Some("srcdoc"),
            DomProp::UseMap => Some("useMap"),
            DomProp::Size => Some("size"),
            DomProp::Min => Some("min"),
            DomProp::Max => Some("max"),
            DomProp::Step => Some("step"),
            DomProp::MaxLength => Some("maxLength"),
            DomProp::MinLength => Some("minLength"),
            DomProp::Rows => Some("rows"),
            DomProp::Cols => Some("cols"),
            DomProp::Dataset(_)
