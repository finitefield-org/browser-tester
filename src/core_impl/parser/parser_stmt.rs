use super::api::{
    ...
    normalize_malformed_escaped_empty_string_literals, parse_block_statements,
    parse_dom_access, parse_expr, parse_queue_microtask_stmt, parse_string_literal_exact,
    split_top_level_by_char, strip_js_comments, strip_outer_parens,
};
use super::*;
