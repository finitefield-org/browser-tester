...
- default actions
- form controls
- text selection state on supported `input` / `textarea` controls (`selectionStart`, `selectionEnd`, `selectionDirection`, `setSelectionRange(...)`, `setRangeText(...)`, and `select()`)
